		...
		<div class="panel panel-default col-sm-6">
		  ...
		  <div class="panel-body">
			<ul class="list-group">
				...
				<li class="list-group-item">
					<a href="#" class="list-group-item">
						<h4 class="list-group-item-heading">JavaScript闭包——懂不懂由你，反正我是懂了 <small>Daliu | 2015-12-8 | 22</small></h4>
						<hr/>
						<p class="list-group-item-text">
							摘要：“如果你不能向一个六岁的孩子解释清楚，那么其实你自己根本就没弄懂。
							”好吧，我试着向一个27岁的朋友就是JS闭包(JavaScript closure)却彻底失败了。
							越来越觉得国内没有教书育人的氛围，为了弄懂JS的闭包，
							我使出了我英语四级吃奶的劲去google上搜寻着有关闭包的解释，
							当我看到stackoverflow上这一篇解答，我脑中就出现了一句话：就是这货没跑了！
						</p>
					</a>
				</li>
				<li class="list-group-item">
