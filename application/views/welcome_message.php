...
<div id="container">
	...
	<div id="body">
		...
		<code>echo "I'm PHPer!";</code>

		<p>通过模块功能，您可以快速找到自己想到去的网站而不用再去“百度一下”费力打老半天的字再搜索点击找到自己想要的网站</p>
		<code>echo "I'm changing the world.";</code>

		<p>通过我们定制的插件你可以方便地添加书签 <a href="user_guide/">下载</a>.</p>
	</div>

	<p class="footer">Page rendered in <strong>{elapsed_time}</strong> seconds. <?php echo  (ENVIRONMENT === 'development') ?  'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?> Copyright © Daliu 2013-2015.</p>
</div>
