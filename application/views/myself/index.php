	...
	<script>
		$(document).ready(function(){
			...
			var system = { 
				...
				touchEndX:'',
				touchEndY:'',
				screenWidth:window.screen.availWidth/DPI,
				screenHeight:(window.screen.availHeight-180)/DPI,
				top:0,
...
function createTem()
{
	var baseX = system.screenWidth/system.DPI;
...
degree.fillText("35℃",baseX+20,baseY-k);
