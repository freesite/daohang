...
<?php $domain = "http://www.freesite.cc/";?>
	...
	<form action="http://www.baidu.com/baidu"target="blank" id=""class="baidu-search">
		<input type="text"id="" autofocus  name="word" class=""placeholder="搜你喜欢的..."><button id=""class="">搜索</button>
	</form>
	<?php 
	for($i=1;$i<17;$i++){
	...
	<div id="win-setting"class="win win-info">
		...
		<div id=""class="win-content">
			...
			<ul id=""class="win-part">
				...
				<li id=""class="">个人作品</li>
				<li id=""class="">消遣</li>
				<li id=""class="">Web前端</li>
				<li id=""class="">时尚</li>
				<li id=""class="">生活常识</li>
				<li id=""class="">PHP</li>
				<li id=""class="">JavaScript</li>
				<li id=""class="">个人修养</li>
			</ul>
			<table id=""class="win-detail">
				<tr id=""class="">
					...
					<td id=""class="">
						<div class="bootstrap-switch bootstrap-switch-mini">
							<input type="checkbox" checked name="state" data-on-label="开启" data-off-label="关闭"/>
						</div>
					</td>
				</tr>
				<tr id=""class="">
					<td id=""class="">名称：</td>
					<td id=""class=""><input type="text"id=""class=""/></td>
				</tr>
				<tr id=""class="">
					<td id=""class="">背景：</td>
					<td id=""class=""><input type="text"id=""class=""/></td>
				...
				<tr id=""class="">
					<td id=""class="">订阅：</td>
					<td id=""class=""><input type="text"id=""class=""placeholder="" disabled/></td>
				</tr>
			</table>
		</div>
	</div>
...
<script src="../sourse/js/jquery.1.11.3.min.js"></script>
